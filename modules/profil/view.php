...
<section class="content">
    ...
    ?>
            ...
            <div class="box box-primary">
                <!-- form start -->
                <form role="form" class="form-horizontal" method="POST" action="?module=form_profil"
              ...
              ?>
                            ...
                            <label style="font-size:25px;margin-top:10px;"
                                class="col-sm-8"><?php echo $data['nama_user']; ?></label>
                        </div>
                        <hr>
                        <div class="form-group">
